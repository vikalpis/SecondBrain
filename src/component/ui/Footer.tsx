    ...
    return (
      <footer className="bg-[#062a55] text-[#d0e3f3]">
        <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Socials */}
          <div>
            <h2 className="text-lg font-semibold text-[#e4229d]">Follow Creator On:</h2>
            <div className="flex space-x-4 mt-3">
              <a href="https://x.com/AnonDev_" className="hover:text-[#486285]">Twitter</a>
              <a href="https://www.linkedin.com/in/vikalp-pandey-303bb0276/" className="hover:text-[#486285]">LinkedIn</a>
              <a href="https://github.com/vikalpis" className="hover:text-[#486285]">GitHub</a>
            </div>
          </div>
        </div>
