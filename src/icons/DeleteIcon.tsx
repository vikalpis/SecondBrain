...
export const DeleteIcon = (props: IconProps)=>{
   return <svg stroke="currentColor" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 24 24" className={iconSizeVariants[props.size]} onClick={props.onClick}>
